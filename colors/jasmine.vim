...
" Paranthesis: {{{2
call s:HL('MatchParen', 'green','NONE','inverse,underline')
...
call s:HL('Constant', 'orange', 'NONE', 'bold')
call s:HL('Boolean', 'green', 'NONE', 'bold')
...
call s:HL('markdownCode', 'orange','faintOrange','italic')
